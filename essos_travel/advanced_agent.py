...
class AdvancedAgent(Agent):
    def reply(self, session, text):
        ...
        if re.search(r"\b(recommend|best option|best one|which would you|which should i|which one should i|which one would you|what would you pick|what should i pick|what's best|whats best)\b", low):
